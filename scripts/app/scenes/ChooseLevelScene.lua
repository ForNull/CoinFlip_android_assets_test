...
function ChooseLevelScene:ctor()
    ...
    -- create levels list
    local rect = CCRect(display.left, display.bottom + 160, display.width, display.height - 280)
...
function ChooseLevelScene:onEnter()
    self.levelsList:checkUnlockLevel()
    self.levelsList:initCellPosition(levelIndex)
    self.levelsList:setTouchEnabled(true)
end

function ChooseLevelScene:onExit()
    -- CCNotificationCenter:sharedNotificationCenter():removeObserver(self,"CHECK_LEVEL_LOCK")
end
